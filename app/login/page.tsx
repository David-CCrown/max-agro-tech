                    ...
                    <div className="max-w-md mx-auto">
                        ...
                        <Card className="border-0 shadow-2xl">
                            <CardHeader className="text-center pb-8">
                                ...
                                <CardDescription className="text-base">
                                    Sign in to your MaxAgroTech account
                                </CardDescription>
                            </CardHeader>
                            <CardContent>
                                <div className="space-y-6">
                                    ...
                                    <div className="flex items-center justify-between text-sm">
                                        <label className="flex items-center gap-2 cursor-pointer">
                                            <input type="checkbox" className="rounded border-gray-300 text-[#4EBE38] focus:ring-[#4EBE38]" />
                                    ...
                                    <div className="text-center text-sm text-gray-600">
                                        ...
                                        <Link href="/register" className="text-[#4EBE38] hover:text-[#24981C] font-semibold">
                                            Create Account
                                        </Link>
                                    </div>
                                </div>
                        ...
                        <div className="mt-6 text-center">
                            <p className="text-sm text-white/70">
                                ...
                                <Link href="#" className="text-[#4EBE38] hover:text-[#24981C]">Terms of Service</Link>
                                {' '}and{' '}
                                <Link href="#" className="text-[#4EBE38] hover:text-[#24981C]">Privacy Policy</Link>
                            </p>
                        </div>
                    </div>
                </div>
